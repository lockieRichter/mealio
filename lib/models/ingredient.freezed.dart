...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String name, Category category});
}
...
class _$_Ingredient implements _Ingredient {
  const _$_Ingredient({this.id, required this.name, required this.category});
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      required final Category category}) = _$_Ingredient;
